...
from utils.sampler import RepeatableSamplerCustom
...
def data_preparation(config, dataset, sampler: Callable=None):
    ...
    if dataloaders is not None:
        ...
        train_sampler, valid_sampler, test_sampler = create_samplers(
            config, dataset, built_datasets, sampler
        ) 
...
def create_samplers(config, dataset, built_datasets, sampler: Callable=None):
    ...
    if train_neg_sample_args["distribution"] != "none":
        ...
        print("Train sample(create_samplers)", train_sampler)
