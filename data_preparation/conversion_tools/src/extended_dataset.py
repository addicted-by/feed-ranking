...
class MINDLargeTrainDataset(BaseDataset):
    ...
    def convert_item(self):
        fin = open(self.item_file, 'r', encoding='utf8')
        fout = open(self.output_item_file, "w", encoding='utf8')
...
class MINDLargeDevDataset(BaseDataset):
    ...
    def convert_inter(self):
        fin = open(self.inter_file, 'r', encoding='utf8')
        fout = open(self.output_inter_file, "w", encoding='utf8')
